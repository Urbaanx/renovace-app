...
import { useGetAdminGetObjectsInRenovations } from "../../api/endpoints/api";
import DataTableHeader from "./DataTableHeader";
import Paginator from "./Paginator";
import ObjectInRenovationModal from "./ObjectInRenovationModal";
import SideBar from "../../components/Sidebar/Sidebar";
import Header from "./Header";
import Menu from "./Menu";

function AdminObjectsInRenovations() {
  const tableHeaders = ["id", "objectId", "renovationId"];
  ...
  const query = useGetAdminGetObjectsInRenovations({
    page: page,
    pageSize: pageSize,
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-8 bg-background pl-16 grid-rows-9 h-dvh w-dvw">
        <Header headerText="Objects In Renovations"></Header>
        <div className="hidden xl:block col-span-1 row-span-8">
          <Menu current="objects in renovations"></Menu>
        </div>
        <div className="col-span-8 xl:col-span-7 row-span-8 px-10 py-20 grid grid-cols-5 rows-12 text-mainColorText overflow-clip">
          <div className="row-span-2 col-span-5 lg:grid grid-cols-4 overflow-scroll hidden ">
            <label className="content-center max-h-6 min-w-28">id</label>
...
export default AdminObjectsInRenovations;
