import { useGetAdminGetRenovationPermissions } from "../../api/endpoints/api";
import { useState } from "react";
import DataTableHeader from "./DataTableHeader";
import Paginator from "./Paginator";
import RenovationPermissionsModal from "./RenovationPermissionsModal";
import SideBar from "../../components/Sidebar/Sidebar";
import Header from "./Header";
import Menu from "./Menu";

function AdminRenovationPermissionsPage() {
  const tableHeaders = ["renovationId", "userId", "canEdit"];
  ...
  const query = useGetAdminGetRenovationPermissions({
    page: page,
    pageSize: pageSize,
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-8 bg-background pl-16 grid-rows-9 h-dvh w-dvw">
        <Header headerText="Renovation Permissions"></Header>
        <div className="hidden xl:block col-span-1 row-span-8">
          <Menu current="renovation permissions"></Menu>
        </div>
...
export default AdminRenovationPermissionsPage;
