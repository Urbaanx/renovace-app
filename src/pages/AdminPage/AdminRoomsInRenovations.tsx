...
import { useGetAdminGetRoomsInRenovations } from "../../api/endpoints/api";
import DataTableHeader from "./DataTableHeader";
import Paginator from "./Paginator";
import RoomInRenovationModal from "./RoomInRenovationModal";
import SideBar from "../../components/Sidebar/Sidebar";
import Header from "./Header";
import Menu from "./Menu";

function AdminRoomsInRenovations() {
  const tableHeaders = ["id", "roomId", "renovationId"];
  ...
  const query = useGetAdminGetRoomsInRenovations({
    page: page,
    pageSize: pageSize,
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-8 bg-background pl-16 grid-rows-9 h-dvh w-dvw">
        <Header headerText="Rooms In Renovations"></Header>
        <div className="hidden xl:block col-span-1 row-span-8">
          <Menu current="rooms in renovations"></Menu>
        </div>
...
export default AdminRoomsInRenovations;
