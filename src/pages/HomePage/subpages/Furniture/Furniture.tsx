...
export default function Furniture({ isMobile }: FurnitureProps) {
  ...
  return (
    <>
      ...
      <div
        className={`${!isMobile ? "ml-16" : "mb-16"} bg-browndark min-h-screen`}
      >
          ...
          <div className="relative z-10 flex md:flex-row justify-between items-center text-background bg-mainColorText md:text-left py-10 px-6 md:px-12 shadow-2xl">
            <div className="md:mb-0">
              ...
              <p className="text-sm font-bold">
                Kliknij na przycisk obok, żeby dodać meble do swojej kolekcji!
                <br />
                Znajdź elementy, które idealnie pasują do Twojego wnętrza!
              </p>
            </div>
          ...
          <div className="p-8">
            ...
            {!isLoading && !error && data?.returnedObjects?.length === 0 && (
              <motion.div className="flex flex-col w-full h-96  place-items-center place-content-center gap-10 ">
                ...
                !generatedFilterUpper ? (
                  ...
                  <p className="text-lg font-semibold">Nie znaleziono mebla.</p>
                )}
              </motion.div>
            )}
            <motion.div
            ...
            >
              {!isLoading &&
                ...
                data.returnedObjects.map((furniture: any, index) => (
                  <FurnitureCard
        ...
        <div className="flex flex-col items-center gap-6 text-background text-sm mt-10">
          <label className="flex flex-col items-center w-full">
            ...
            >
              ...
              <p
                className={`w-full px-2 mt-6 font-bold text-center text-wrap overflow-hidden text-ellipsis ${
