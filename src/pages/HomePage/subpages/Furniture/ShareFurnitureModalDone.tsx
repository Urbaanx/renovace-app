...
function ShareFurnitureModalDone({ onClose }: ShareRoomModalDoneProps) {
  return (
    <div className="fixed inset-0 bg-black bg-opacity-40 flex justify-center items-center z-50">
      <div className="bg-mainColorText rounded-2xl p-10 w-full max-w-md relative shadow-lg text-background text-center">
        ...
        <p className="mb-6 text-sm font-medium">
          Mebel został udostępniony podanemu użytkownikowi
        </p>
...
export default memo(ShareFurnitureModalDone);
