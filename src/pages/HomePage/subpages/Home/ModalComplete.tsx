  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose}>
      <div className="flex flex-col items-center justify-center text-background text-sm mt-12">
        ...
        <p className="text-center mt-6 mb-8">Twoj pokój został przesłany</p>
        ...
        <p className="text-center mt-10 mb-4">
          Możesz go znaleźć w zakładce Moje Pokoje
          <br />
          lub przejść do niego teraz!
        </p>

        <div className="flex justify-center mt-8 space-x-4">
          <Button
            onClick={onClose}
            className="text-backgroundComponents border border-backgroundComponents px-14 py-2 rounded shadow-md"
          >
            Zamknij
          </Button>
          <button
            onClick={onClose}
            className="bg-backgroundComponents text-mainColorText px-6 py-2 rounded shadow-md"
          >
            Przejdź do pokoju
          </button>
        </div>
