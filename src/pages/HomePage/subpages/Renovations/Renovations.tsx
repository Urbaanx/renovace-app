...
import { useGetApiRoomAvailable } from "../../../../api/endpoints/api";
import { useGetApiRenovationAvailable } from "../../../../api/endpoints/api";
import { usePostApiRenovation } from "../../../../api/endpoints/api";
...
export default function Renovations({ isMobile }: RenovationsProps) {
  ...
  return (
    <>
          ...
          <div className="relative z-10 flex md:flex-row justify-between items-center text-background bg-mainColorText md:text-left py-10 px-6 md:px-12 shadow-2xl">
            <div className="md:mb-0">
              ...
              <p className="text-sm font-bold">
                Kliknij na przycisk obok, żeby zacząć renowację wybranego przez
                ciebie pokoju!
                <br />
                Stwórz przestrzeń, która odzwierciedli Twój styl!
              </p>
            </div>
                    ...
                    >
                      ...
                      >
                        {roomsData?.returnedObjects?.length === 0 ? (
                          ...
                          <Button onClick={openModal}>Stwórz renowację!</Button>
                        )}
                      </motion.div>
                    </motion.div>
                  ) : (
          ...
          <div className="p-12 w-full max-w-lg bg-transparent">
            ...
            <div className="flex justify-center h-48">
              {isRoomsLoading ? (
                ...
                <p className="text-lg font-semibold">Brak dostępnych pokoi.</p>
              )}
            </div>
      ...
      <ModalLoading isOpen={isLoadingModalOpen} onClose={closeLoadingModal} />
